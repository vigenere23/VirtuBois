...
import virtubois.presentation.controllers.MainController;
...
import static virtubois.helpers.ColorHelper.hex2Rgb;
...
//https://github.com/afsalashyana/JavaFX-3D/blob/master/src/gc/tutorial/chapt4/Rotation3DWithMouse.java
    ...
    public void draw() {
        for (BundleDto bundle : allBundles) {
            ...
            material.setDiffuseMap(new Image("/virtubois/presentation/assets/images/bois.jpg"));
    ...
    private void setInitialGroupTranslate() {
        ...
        for (BundleDto bundle : allBundles) {
            ...
            for (virtubois.helpers.Point2D position : presenter.getPoints()) {
        ...
        Image image = new Image("/virtubois/presentation/assets/images/asphalte.jpg", 3000, 3000, true, true);
